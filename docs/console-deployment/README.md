...
Install your chosen [database plugin](https://hot-updater.dev/docs/concepts/plugin-system#database-plugin) and [storage plugin](https://hot-updater.dev/docs/concepts/plugin-system#storage-plugin). Read credentials from runtime environment variables inside the callback.
...
| Host | Runtime |
| --- | --- |
| [Docker](docker.md) | Standalone Node container |
| [Vercel](vercel.md) | Node server functions |
| [Netlify](netlify.md) | Node server functions |
| [Cloudflare](cloudflare.md) | Worker with native D1/R2 bindings |
...
| --- | --- | --- |
| Cloudflare | [D1 API](https://hot-updater.dev/docs/database-plugins/cloudflare) + [R2 S3 credentials](https://hot-updater.dev/docs/storage-plugins/cloudflare) | Native bindings |
...
Use Node-compatible plugins. For native bindings, use the [Worker preview](cloudflare.md#local-preview).

</details>
<details>
<summary>Sign-in troubleshooting</summary>
