...
Complete the [basic setup](README.md) first: connect your existing backend,
...
For D1/R2, follow [Cloudflare from Node](README.md#cloudflare-backend-from-node);
...
Edit `.env.production` with the values from [authentication setup](README.md#3-configure-authentication):
